...
int main(void)
{
  ...
  while (1)
  {
    ssd1306_basic_string(0, 0, "Hello World!1",strlen("Hello World!1"), 1, SSD1306_FONT_16);
    ssd1306_basic_clear();
    ssd1306_basic_string(0, 0, "Hello World!2",strlen("Hello World!2"), 0, SSD1306_FONT_16);
    ssd1306_basic_clear();

    HAL_GPIO_TogglePin(BOARD_LED_GPIO_Port,BOARD_LED_Pin);
    HAL_Delay(1500);
    HAL_UART_Transmit(&huart1, (uint8_t *)"Hello World!1\r\n", 16, 0xFFFF);
    HAL_UART_Transmit(&huart2, (uint8_t *)"Hello World!2\r\n", 16, 0xFFFF);
    /* USER CODE END WHILE */
